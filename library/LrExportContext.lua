...
---@field exportSession table The list of photos and renditions to be exported in this session.
...
---@return LrProgressScope # A progress scope tied specifically to the export rendering pipeline. See also LrProgressScope
